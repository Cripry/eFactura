...
from machine.invoice_signer_ddd.domain.models.image_paths import ImagePaths
from machine.invoice_signer_ddd.domain.exceptions import USBNotFoundException
import logging
import time
import cv2
import numpy as np
...
class MSignDesktopHandler:
    ...
    def input_pin(self, pin: str) -> bool:
        ...
        try:
            ...
            pin_window = self.app.window(title="Introduceți noul cod PIN")
